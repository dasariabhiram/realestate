...
const PropertyDetails:React.FunctionComponent<PropertyDetailsprops> = ({ propertyDetails: { price, rentFrequency, rooms, title, baths, area, agency, isVerified, description, type, purpose, furnishingStatus, amenities, photos } }: any) => (
